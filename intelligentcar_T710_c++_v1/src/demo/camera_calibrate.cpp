...
bool cameraCalibration(string imagesFolder)
{
    ...
    for (int i = 0; i < imagesPath.size(); i++)
    {
        ...
        icarShow.init(2);
        icarShow.setNewWindow(0, imageSource, "imageSource");   // 添加需要显示的图像
        icarShow.setNewWindow(1, imageCorrect, "imageCorrect"); // 添加需要显示的图像
