...
public:
    ...
    struct Params
    {
        ...
        string pathVideo = "../res/samples/demo.mp4"; // 视频路径
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(Params, speedLow, speedHigh, speedDown, speedFreezone, speedGasBusy, speedSlop, speedGarage,
                                       runP1, runP2, runP3, turnP, turnD, debug, saveImage, rowCutUp, rowCutBottom, disGarageEntry,
                                       GarageEnable, GasStationEnable, BusyAreaEnable, SlopEnable, FreezoneEnable, RingEnable, CrossEnable, circles, pathVideo); // 添加构造函数
    };
