...
capture = cv2.VideoCapture("../../res/samples/freezoneDet.mp4")  # 选择本地视频
...
while True:
    ...
    base64freezoneDet = matToBase64(True, imageCorret)
    icar.freezoneDetDrawImage(base64freezoneDet)  # 可视化显示识别结果
