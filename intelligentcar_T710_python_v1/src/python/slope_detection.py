...
capture = cv2.VideoCapture("../../res/samples/slope.mp4")  # 选择本地视频
...
while True:
    ...
    # 坡道（桥）检测与路径规划
    icar.slopeDetection()
    base64slope = matToBase64(True, imageCorret)
    icar.slopeDrawImage(base64slope)  # 可视化显示识别结果
