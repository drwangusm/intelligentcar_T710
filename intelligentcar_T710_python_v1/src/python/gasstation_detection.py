...
capture = cv2.VideoCapture("../../res/samples/gasstation.mp4")  # 选择本地视频
...
while True:
    ...
    base64gasstation = matToBase64(True, imageCorret)
    icar.gasStationDrawImage(base64gasstation)  # 可视化显示识别结果
