...
while True:
    ...
    cv2.putText(imageFrame, "[1] frame",(10, 30), cv2.FONT_HERSHEY_TRIPLEX, 1,(255, 0, 0), 1)
    cv2.putText(imageCorret, "[2] imgCorret",(10, 30), cv2.FONT_HERSHEY_TRIPLEX, 1,(255, 0, 0), 1)
    cv2.putText(imageBinary, "[3] imgBinary",(10, 30), cv2.FONT_HERSHEY_TRIPLEX, 1,(255, 0, 0), 1)
