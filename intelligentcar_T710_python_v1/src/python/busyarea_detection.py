...
capture = cv2.VideoCapture("../../res/samples/busyArea.mp4")  # 选择本地视频
...
while True:
    ...
    base64busyarea = matToBase64(True, imageCorret)
    icar.busyareaDrawImage(base64busyarea)  # 可视化显示识别结果
