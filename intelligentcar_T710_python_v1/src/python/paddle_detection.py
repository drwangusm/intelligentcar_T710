"""
Description:    AI目标检测（特殊赛道处理）|demo
Version:        v1.0
Autor:          Leo
...
while True:
    ...
    icar.garageDrawImage(base64Corret)  # 可视化显示识别结果

    # 施工区检测与路径规划
    icar.busyareaDetection()
    icar.busyareaDrawImage(base64Corret)

    # 加油站检测与路径规划
    icar.gasStationDetection()
    icar.gasStationDrawImage(base64Corret)

    # 泛行区检测与路径规划
    icar.freezoneDetection()
    icar.freezoneDetDrawImage(base64Corret)
