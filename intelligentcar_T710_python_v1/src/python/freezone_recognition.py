...
capture = cv2.VideoCapture("../../res/samples/freezone.mp4")  # 选择本地视频
...
while True:
    ...
    # 泛行区识别
    icar.freezoneRecognition()
    base64Freezone = matToBase64(True, imageCorret)
    icar.freezoneDrawImage(base64Freezone)  # 可视化显示识别结果
